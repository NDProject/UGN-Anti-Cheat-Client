...
namespace UGN_Client
{
    ...
    public static class ImageResize
    {
        ...
        public static void Run(string filePath, int newWidth, int newHeight)
        {
            TfilePath = filePath;
            TnewWidth = newWidth;
            ...
            Save(image, TnewWidth, TnewHeight, 1, TfilePath);
        }
        ...
        private static void Save(Bitmap image, int maxWidth, int maxHeight, int quality, string filePath)
        {
            ...
            // Convert other formats (including CMYK) to RGB.Format24bppRgb
